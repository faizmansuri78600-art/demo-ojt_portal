...
const EvaluationTable = ({
  ...
  const [activeTab, setActiveTab] = useState(selectedTab || "pending");
                ...
                <td className="py-3 px-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="relative">
                      ...
                      {/* Dropdown */}
                      {openMenu === student.id && (
                        <div className="absolute right-0 top-10 z-30 w-48 bg-white border border-gray-200 rounded-lg shadow-lg py-1">

                          {/* Student Details */}
                          <button
                            onClick={() => {
                              navigate(
                                `/faculty/StudentDetails/${student.studentId}`
                              );
                              setOpenMenu(null);
                            }}
