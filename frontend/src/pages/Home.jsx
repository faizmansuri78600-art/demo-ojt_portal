  ...
  return ( 
    <div className="overflow-hidden"> 
      ...
      {/* ========================================================= 
          HERO 
      ========================================================= */} 
      <section className="relative bg-gradient-to-r from-[#f5f9ff] blue to-[#f4f8ff]"> 
    ...
    PORTALS 
========================================================= */} 
<section className="bg-blue px-5 py-10 sm:px-8"> 
  ...
  <div className="mx-auto max-w-[1300px]"> 
    ...
    <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3"> 
      ...
      <PortalCard 
        ...
        description="Register, explore opportunities, apply for OJT and track your progress. get certificate after compiletion" 
      ...
      {/* Company coordinator Portal */} 
      <PortalCard 
        to="/login"
        icon={<Building2 size={25} />} 
        title="Company-coordinator Portal" 
        description="update OJT opportunities, update applications, monitors students and maintain performance." 
        button="Enter Company-coordinator Portal" 
        color="bg-blue-500" 
        bg="bg-[#faf7ff]" 
      /> 
      ...
      <PortalCard 
        ...
        description="Monitors students, approve or reject their attendence, monitor OJT activities." 
