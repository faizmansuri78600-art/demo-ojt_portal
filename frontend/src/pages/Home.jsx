...
function Home() {
  return (
    <div className="min-h-screen overflow-hidden bg-[#eef4ff]">

      {/* =========================================================
          HERO
      ========================================================= */}
      <section className="relative bg-blue from-[#f5f9ff] via-white to-[#f4f8ff]">
        <div className="mx-auto grid min-h-[360px] max-w-[1400px] items-center gap-4 px-6 py-10 sm:px-10 lg:grid-cols-[43%_57%] lg:px-12 lg:py-7">
  ...
  <div className="mx-auto max-w-[1300px]"> 
    ...
    <div className="mt-5 grid gap-4 sm:grid-cols-4"> 
      ...
      {/* =========================================================
          WHY OJT
      ========================================================= */}
      <section className="px-5 pb-9 sm:px-8">
        <div className="mx-auto max-w-[1250px]">
          ...
          <div className="mt-5 grid grid-cols-1 divide-y divide-gray-200 border-t border-gray-200 pt-4 sm:grid-cols-2 sm:divide-y-0 lg:grid-cols-5">
